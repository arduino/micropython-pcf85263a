...
def test_alarms():
    ...
    # Configure Alarm 1 for exactly 59 seconds (2 seconds from now)
    print("Setting Alarm 1 for 59 seconds...")
    ...
    # Configure Alarm 2 for minute 0 (3 seconds from now when rollover happens to 00:00:00)
    print("Setting Alarm 2 for 0 minutes...")
    ...
    print("Waiting 3 seconds for Alarm 1...")
    time.sleep(3)
